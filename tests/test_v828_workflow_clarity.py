...
def test_v828_dashboard_and_record_actions_are_explicit_and_mobile_friendly():
    ...
    assert "WORKFLOW CLARITY V8.28.2" in index
    assert "/static/app.js?v=enquiry-confirmation-v8-28-2" in index
    assert "/static/v811.js?v=enquiry-confirmation-v8-28-2" in index
